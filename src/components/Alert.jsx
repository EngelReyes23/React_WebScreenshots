...
export const Alert = ({ msg }) => {
  ...
  return (
    <div
      class='flex p-4 mb-4 bg-red-100 border-t-4 border-red-500 dark:bg-red-200 animate__animated animate__bounceIn'
      role='alert'
    >
      <svg
      ...
      <div class='ml-3 text-sm font-medium text-red-700'>{msg}</div>
      <button
        type='button'
